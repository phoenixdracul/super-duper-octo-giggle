 ...
 * 							  Force Information	 					    	*
 * 																			*
 *  Skill information for forcers and force helpfiles.						*
 * 																			*
 +--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--+
 *																			*
...
DO_FUN *get_force_skill_function(char *name)
{
	...
	case 'a':
    	...
    	case 'i':
    	    ...
    	    if ( !str_cmp( name, "fskill_instill"))		return fskill_instill;
    	...
    	case 's':
    	    ...
    	    break;
    	case 't':
    		if( !str_cmp( name, "fskill_telepathy"))	return fskill_telepathy;
    		break;
    	case 'w':
