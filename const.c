 ...
 * 							  Constants Tables	 					    	*
 * 																			*
 *  Stuff like classes, races, builds and liquid states.					*
 * 																			*
 +--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--+
 *																			*
...
{
		"Soldier", "Piloting", "Engineering", "Bounty Hunting", "Smuggling", "Politician", "Force", "Slicer", "Assassin", "Technician",
		"Brawler"
};
...
{
"Normal", "Gaseous", "Heat", "Blizzard", "Thin Air", "Oxygenized",
"Toxic", "Windy"
};
...
const char *	const	attack_table	[MAX_ATTACKS] =
{
		"hit",
