 ...
 * 						      SMAUG Magic System 					    	*
 * 																			*
 *  Framework for all the SMAUG spells, herbs etc. This has been partially  *
 *  replaced by the new SWFotE Force system.								*
 * 																			*
 +--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--+
 *																			*
...
//        force_exp = skill->min_level*skill->min_level*10;
        force_exp = exp_gain(ch->skill_level[FORCE_ABILITY], sn);
