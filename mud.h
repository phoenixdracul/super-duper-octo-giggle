...
typedef struct  lottery_data 	LOTTERY_DATA;
...
typedef struct  hangar_data             HANGER_DATA;
...
#define PULSE_BET				  (15 * PULSE_PER_SECOND)
#define PULSE_LOTTERY             ( 60 * PULSE_PER_SECOND )
...
typedef enum
{
  ...
  FORCE_SKILL_MAKEDUALSABER, FORCE_SKILL_AWARENESS, FORCE_SKILL_DISARM, FORCE_SKILL_SPEED,
  FORCE_SKILL_FARSEE, FORCE_SKILL_TELEPATHY, FORCE_SKILL_INSTILL
} force_skills_type;
...
#define MAX_FORCE_SKILL 28	// TODO
...
#define MAX_FORCE_ALIGN 1000
#define MIN_FORCE_ALIGN -1000
...
#define OOC_HISTORY_MAX 10	/* Keeps x ooc commands */

/* OOC History structure (FIFO)
 * Added by Boran
 */

struct ooc_history
{
	char *messages[OOC_HISTORY_MAX];
	int size;
};
...
typedef enum
{
  ...
  CON_GET_DROID, CON_COMFIRM_NEW_ACCOUNT, CON_GET_OLD_ACCOUNT_PASSWORD,
     CON_ACCOUNT_PENDING, CON_CONFIRM_NEW_ACCOUNT, CON_ACCOUNT_ADD_CHARACTER_PASSWORD,
     CON_GET_NEW_ACCOUNT_PASSWORD, CON_COMFIRM_ACCOUNT_PASSWORD,
     CON_GET_ACCOUNT, CON_FORKED, CON_IAFORKED
} connection_types;
...
typedef enum
{
  ...
  SUB_ROOM_EXIT_DESC, SUB_WRITING_NOTE, SUB_MPROG_EDIT, SUB_HELP_EDIT, SUB_BLUEPRINTING,	// TODO
  SUB_WRITING_MAP, SUB_PERSONAL_BIO, SUB_REPEATCMD, SUB_RESTRICTED,
  SUB_DEITYDESC,SUB_PROJ_DESC,SUB_SHIPDESC,SUB_FORCE_CH0,SUB_FORCE_CH1,SUB_FORCE_CH2,
...
struct	shop_data
{
    ...
    BOOL	playershop;		/* Whether or not it's a playershop */
    BOOL	clanshop;		/* Whether or not it's a clanshop	*/
    char *owner;			/* Owner of the shop. */
};
...
typedef enum {PLAYER_SHIP, MOB_SHIP, SHIP_IMPERIAL, SHIP_REPUBLIC, SHIP_NEUTRAL} ship_types;
...
typedef enum {
	...
	SHIP_CORVETTE, SHIP_LFRIGATE, SHIP_CRUISER, SHIP_DREADNAUGHT, SHIP_DESTROYER, SHIP_SPACE_STATION
} ship_classes;

typedef enum {
	// 0         1              2               3               4              5              6                7              8
	B_NONE, LIGHT_LASER_NR, SINGLE_LASER_NR, DUAL_LASER_NR, TRI_LASER_NR, QUAD_LASER_NR, AUTOBLASTER_NR, HEAVY_LASER_NR, TURBOLASER_NR,
	//    9              10              11              12             13            14               15             16
	LIGHT_LASER_GE, SINGLE_LASER_GE, DUAL_LASER_GE, TRI_LASER_GE, QUAD_LASER_GE, AUTOBLASTER_GE, HEAVY_LASER_GE, TURBOLASER_GE,
	//    17             18            19           20            21            22               23             24
	LIGHT_LASER_B, SINGLE_LASER_B, DUAL_LASER_B, TRI_LASER_B, QUAD_LASER_B, AUTOBLASTER_B, HEAVY_LASER_B, TURBOLASER_B,
	//    25              26            27            28           29            30             31            32
	LIGHT_LASER_P, SINGLE_LASER_P, DUAL_LASER_P, TRI_LASER_P, QUAD_LASER_P, AUTOBLASTER_P, HEAVY_LASER_P, TURBOLASER_P,
	//    33            34          35         36         37         38           39       40      41
	LIGHT_ION, REPEATING_ION, HEAVY_ION, LIGHT_PLASMA, PLASMA, HEAVY_PLASMA, LIGHT_MASS, MASS, HEAVY_MASS,
        //  42         43        44         45         46         47           48       49      50
        C_MISSILE, P_TORPEDO, H_ROCKET 
} beam_types;
...
struct  planet_data
{
    ...
    int		     barracks;
#ifdef USECARGO
    int              imports[CARGO_MAX];
    int              exports[CARGO_MAX];
...
struct	clan_data
{
    ...
    char *	number1;	/* General       			*/
    char *	number2;	/* Major General			*/
    char *      number3;        /* Colonel                              */
    char *      number4;        /* Major                                */
    char *      number5;
    char *      number6;        /* Captain                              */
    char *      number7;        /* First Lieutenant                     */
...
/* New ship shit by || && Tawnos for FotE */
    ...
    sh_int	tertiaryState;  // () Tertiary beam state
	...
	sh_int  tertiaryType; // Tertiary weapon type, defined in beam_types
	...
	BOOL	tertiaryLinked;   // Linked fire, if !single will fire all available
    ...
    sh_int		tertiaryCount;   // () Number of tertiaries
...
typedef enum
{
     ACT_IS_NPC, ACT_SENTINEL, ACT_SCAVENGER, ACT_NOFLEE, ACT_R4, ACT_AGGRESSIVE, ACT_STAY_AREA, ACT_WIMPY,
     ACT_PET, ACT_TRAIN, ACT_PRACTICE, ACT_IMMORTAL, ACT_DEADLY, ACT_POLYSELF,
     ACT_META_AGGR, ACT_GUARDIAN, ACT_RUNNING, ACT_NOWANDER, ACT_MOUNTABLE, ACT_MOUNTED,
     ACT_SCHOLAR, ACT_SECRETIVE, ACT_POLYMORPHED, ACT_MOBINVIS, ACT_NOASSIST, ACT_NOKILL,
     ACT_DROID, ACT_NOCORPSE, ACT_PUEBLO, ACT_R29, ACT_PROTOTYPE, ACT_R31
}mobile_act_flags;
...
#define ACT_TRESPASS	 BV05		/* Set when the player is in the process of trespassing into a room */
...
/* Bits for affected_by2   -   Added by Boran */
...
// Added by Boran.
#define ATCK_BASH		  BV11
#define ATCK_STUN		  BV12
#define ATCK_GOUGE		  BV13
...
#define OBJ_VNUM_VENDOR_AGREEMENT	39
#define OBJ_VNUM_ROULETTE			42
#define OBJ_VNUM_LOCKER           44
...
#define AFFECT_TERTIARY         16
#define AFFECT_BOMB		17
#define AFFECT_CARGO		18
/*
 * Item types.
 * Used in #OBJECTS.
 */
typedef enum
{
  ...
  ITEM_RLAUNCHER, ITEM_BINDERS, ITEM_GOGGLES, ITEM_SHIPBOMB, ITEM_EMP_GRENADE, ITEM_BLUEPRINT, ITEM_CRYSTALORE,
  // New items below. -- Kasji
  ITEM_RESOURCE
} item_types;

// Resource types -- Kasji
typedef enum
{
	RSRC_
} resource_types;

#define MAX_ITEM_TYPE		     ITEM_CRYSTALORE
/*
 * Extra flags.
 * Used in #OBJECTS.
 */
...
#define ROOM_START_IMMORTAL        1000
...
#define BLUEPRINT_AREA			"blueprint.are"
...
#define ROOM_H_RECRUIT		BV13
#define ROOM_LOCKER    		BV14
#define ROOM_LOGSPEECH		BV15
/*
 * Directions.
 * Used in #ROOMS.
 */
...
typedef enum
{
  ...
  POS_SITTING, POS_FIGHTING, POS_STANDING, POS_MOUNTED, POS_SHOVE, POS_DRAG, POS_MAX
} positions;
...
#define PCFLAG_BUILDWALK		   BV13
#define PCFLAG_AUTODRAW			   BV14
#define PCFLAG_NOPROX			BV15
...
/* Second set of channel bits - Boran */

#define CHANNEL_CODENET			BV00
#define CHANNEL_BUILDNET		BV01
...
struct	pc_data
{
    ...
    int 		lottery_number; /* Player's lottery number */
...
#define TYPE_EXPLOSION			3001	/* Used in room_explode_1 */
#define TYPE_FORCE_SPECIAL		3002	/* Used for some force skills damage */
/*
 *  Target types.
 */
typedef enum
...
extern sh_int 	gsn_makeblueprint;
...
extern	char *	const	ship_dir_name	[];
...
extern  struct  lottery_data    lottery;
extern	int	top_sn;
...
extern		OOC_HISTORY			ooc_history;
...
#define VENDOR_DIR	"../vendors/"	/* Player and clan shops dir  */
#define LOCKER_DIR	"../lockers/"	/* Where player lockers be at */
...
#define LOTTERY_FILE    SYSTEM_DIR "lottery.dat"
...
SHIP_DATA  * ship_from_window       args( ( int vnum ) );
...
void 	fwrite_locker args( ( CHAR_DATA * ch, OBJ_DATA * locker, BOOL foot ) );

#define MAX_VENDORS	 3000
int 	vendorvnums[MAX_VENDORS];
