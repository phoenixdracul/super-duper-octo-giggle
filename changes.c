 ...
 * 							    Changes System	 							*
 * 																			*
 * 	Keeps track of changes made to the codebase, areas, website etc.     	*
 * 																			*
 +--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--+
 *																			*
...
void do_changes(CHAR_DATA *ch, char *argument) 
{
	...
	/* Update the character and account last_changes field. */
	ch->pcdata->last_changes = current_time;
	if(ch->pcdata->account)
		ch->pcdata->account->last_changes = current_time;
